...
function onEvent(tag, val1, val2)
    ...
    elseif tag == 'Change Character' then
        ...
        setSpriteShader('dad', 'RTXLighting')
        setSpriteShader('gf', 'RTXLighting')
        setSpriteShader('buildings12', 'RTXLighting')
        setSpriteShader('buildings22', 'RTXLighting')
        setSpriteShader('ground2', 'RTXLighting')
        setSpriteShader('overheadlights2', 'RTXLighting')
        updateShader()
    end
end
